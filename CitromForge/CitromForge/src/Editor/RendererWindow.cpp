                        ...
                        if (ImGui::TreeNode(obj.name.c_str()))
                        {
                            ...
                            switch (obj.propertyFormat)
                            {
                                ...
                                case MaterialFormat::Float32:
                                    ImGui::Text("Value: %f", *static_cast<float*>(dataPtr));
                                    break;
                                case MaterialFormat::Float32x3:
                                    ImGui::Text("Value0: %f", static_cast<float*>(dataPtr)[0]);
                                    ImGui::Text("Value1: %f", static_cast<float*>(dataPtr)[1]);
                                    ImGui::Text("Value2: %f", static_cast<float*>(dataPtr)[2]);
                                    break;
                                case MaterialFormat::Float32x4:
                                    ImGui::Text("Value0: %f", static_cast<float*>(dataPtr)[0]);
                                    ImGui::Text("Value1: %f", static_cast<float*>(dataPtr)[1]);
                                    ImGui::Text("Value2: %f", static_cast<float*>(dataPtr)[2]);
                                    ImGui::Text("Value3: %f", static_cast<float*>(dataPtr)[3]);
                                    break;
                                case MaterialFormat::Float32x4x4:
                                    //ImGui::Text("Value0_0" ": %f", static_cast<float**>(dataPtr)[0][0]);
                                    //ImGui::Text("Value1_0" ": %f", static_cast<float**>(dataPtr)[1][0]);
                                    //ImGui::Text("Value2_0" ": %f", static_cast<float**>(dataPtr)[2][0]);
                                    //ImGui::Text("Value3_0" ": %f", static_cast<float**>(dataPtr)[3][0]);

                                    for (int i = 0; i < 4; ++i)
                                        for (int j = 0; j < 4; ++j)
                                            ImGui::Text("Value%d_%d: %f", i, j, static_cast<float**>(dataPtr)[i][j]);
                                    break;

                                case MaterialFormat::Int32:
                                    ImGui::Text("Value: %i", *static_cast<int32*>(dataPtr));
                                    break;
                                case MaterialFormat::UInt32:
                                    ImGui::Text("Value: %u", *static_cast<uint32*>(dataPtr));
                                    break;
                            }
