...
namespace Citrom::RenderAPI
{
	...
	public:
		...
		virtual void MakeSwapChain(SwapChainDesc* descriptor, BlendStateDesc* blendSpec = nullptr, RasterizerStateDesc* rasterDesc = nullptr) = 0; // TODO: think about moving states to another function
